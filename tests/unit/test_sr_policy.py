...
def test_sr_policy_nlri_ipv4_pack_unpack():
    ...
    assert packed[0] == 12  # Length byte = 12 (size of Dist + Color + Endpoint)
...
def test_sr_policy_nlri_ipv6_pack_unpack():
    ...
    assert packed[0] == 24  # Length byte = 24 (size of Dist + Color + Endpoint)
...
def test_segment_type_j_with_sid():
    seg = SegmentTypeJ(local_if_id=3, local_ipv6='fc00::3', remote_if_id=4, remote_ipv6='fc00::4', algorithm=1, sid='fc00::300')
    packed = seg.pack()
    # + sid(16) = 60 bytes
...
def test_segment_type_j_with_sid_and_eb():
    eb = SRv6EndpointBehavior(endpoint_behavior=65, lb_length=32, ln_length=0, fun_length=16, arg_length=0)
    seg = SegmentTypeJ(local_if_id=5, local_ipv6='fc00::5', remote_if_id=6, remote_ipv6='fc00::6', algorithm=0, sid='fc00::400', endpoint_behavior=eb)
    packed = seg.pack()
...
def test_segment_list_with_type_i_j_k():
    ...
    segments = [
        ...
        SegmentTypeJ(local_if_id=1, local_ipv6='fc00::2', remote_if_id=2, remote_ipv6='fc00::3', algorithm=0, sid='fc00::200'),
...
def test_rfc9012_subtlv_type_ge_128_uses_2byte_length():
    ...
    test_cases = [
        (SegmentListSubTLV(
            weight=WeightSubSubTLV(weight=1),
            segments=[SegmentTypeA(label=16001)]
        ), 128, 17),  # Reserved(1) + Weight sub-sub-TLV(8) + Segment Type A(8) = 17
...
def test_rfc9012_sr_policy_tunnel_round_trip():
    ...
    original = SRPolicyTunnel(subtlvs=[
...
def test_segment_list_all_srv6_types_combined():
    ...
    segments = [
        ...
        SegmentTypeJ(
            local_if_id=1, local_ipv6='fc00::3',
            remote_if_id=2, remote_ipv6='fc00::4',
            algorithm=0, sid='fc00::200', endpoint_behavior=eb,
        ),
