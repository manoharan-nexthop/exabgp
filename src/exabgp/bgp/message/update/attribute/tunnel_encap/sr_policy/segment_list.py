...
class SRv6EndpointBehavior:
    ...
    def pack(self) -> bytes:
        ...
        return pack('!HHBBBB', self.endpoint_behavior, 0, self.lb_length, self.ln_length, self.fun_length, self.arg_length)
...
class SegmentTypeG:
    ...
    VALUE_BASE_SIZE: ClassVar[int] = 42  # flags(1) + reserved(1) + local_if(4) + local_ipv6(16) + remote_if(4) + remote_ipv6(16)
...
class SegmentTypeJ:
    ...
    VALUE_BASE_SIZE: ClassVar[int] = 42  # flags(1) + algorithm(1) + local_if_id(4) + local_ipv6(16) + remote_if_id(4) + remote_ipv6(16)
...
def _unpack_segment_subsubtlvs(data: Buffer) -> tuple[WeightSubSubTLV | None, list[SegmentTypeA | SegmentTypeB | SegmentTypeC | SegmentTypeD | SegmentTypeE | SegmentTypeF | SegmentTypeG | SegmentTypeH | SegmentTypeI | SegmentTypeJ | SegmentTypeK]]:
    """Parse segment list body: weight + segments."""
    weight: WeightSubSubTLV | None = None
    segments: list[SegmentTypeA | SegmentTypeB | SegmentTypeC | SegmentTypeD | SegmentTypeE | SegmentTypeF | SegmentTypeG | SegmentTypeH | SegmentTypeI | SegmentTypeJ | SegmentTypeK] = []
